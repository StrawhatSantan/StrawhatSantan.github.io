    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-diffusion-based-authentication-of-copy-detection-patterns",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Bolutife_Atoki_CV.pdf", "_blank");
        },
      },{
        id: 'social-dblp',
        title: 'DBLP',
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.org/pid/394/9445", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%74%6F%6B%69%62%75%6E%6D%69@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/StrawhatSantan", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/bolutife-atoki-a2b7a3196", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/atokibunmi", "_blank");
        },
      },];
